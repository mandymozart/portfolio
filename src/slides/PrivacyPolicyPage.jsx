...
const PrivacyPolicyPage = () => {
  return (
    <Container>
      ...
      <p>
        We are very delighted that you have shown interest in our services. Data
        protection is of a particularly high priority to me. The use of the
        Internet pages of the Tilman Porschütz Developer is possible without any
      ...
      <p>
        ...
        Tilman Porschütz Developer. By means of this data protection
      ...
      <p>
        As the controller, the Tilman Porschütz Developer has implemented
      ...
      <h4>1. Definitions</h4>
      <p>
        The data protection declaration of the Tilman Porschütz Developer is
      ...
      <p>
        The website of the Tilman Porschütz Developer collects a series of
      ...
      <p>
        When using these general data and information, the Tilman Porschütz
        Developer does not draw any conclusions about the data subject. Rather,
        ...
        prosecution in case of a cyber-attack. Therefore, the Tilman Porschütz
        Developer analyzes anonymously collected data and information
      ...
      <p>
        The newsletter of the Tilman Porschütz Developer contains so-called
        ...
        pixel, the Tilman Porschütz Developer may see if and when an e-mail was
        opened by a data subject, and which links in the e-mail were called up
        by data subjects.
      </p>
      ...
      <p>
        ...
        controller. The Tilman Porschütz Developer automatically regards a
        withdrawal from the receipt of the newsletter as a revocation.
      </p>

      <h4>6. Subscription to comments in the blog on the website</h4>
      <p>
        The comments made in the blog of the Tilman Porschütz Developer may be
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            ...
            wishes to request the erasure of personal data stored by the Tilman
            Porschütz Developer, he or she may, at any time, contact any
            employee of the controller. An employee of Tilman Porschütz
            Developer shall promptly ensure that the erasure request is complied
            with immediately.
          </p>
          ...
          <p>
            ...
            as processing is not required. An employees of the Tilman Porschütz
            Developer will arrange the necessary measures in individual cases.
          </p>
        </li>
        <li>
        ...
        <li>
          ...
          <p>
            ...
            may at any time contact any employee of the Tilman Porschütz
            Developer.
          </p>
        </li>
        <li>
          ...
          <p>
            The Tilman Porschütz Developer shall no longer process the personal
          ...
          <p>
            If the Tilman Porschütz Developer processes personal data for direct
            ...
            Tilman Porschütz Developer to the processing for direct marketing
            purposes, the Tilman Porschütz Developer will no longer process the
          ...
          <p>
            ...
            data concerning him or her by the Tilman Porschütz Developer for
          ...
          <p>
            ...
            contact any employee of the Tilman Porschütz Developer. In addition,
        ...
        <li>
          ...
          <p>
            ...
            contact any employee of the Tilman Porschütz Developer.
          </p>
        </li>
        <li>
